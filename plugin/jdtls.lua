...
local function enable_debugger(bufnr)
    ...
    map('n', '<leader>tc', "<CMD>lua require('jdtls').test_class()<CR>", { buffer = bufnr, desc = "Test class" })
...
local function jdtls_on_attach(_, bufnr)
    ...
    map('x', '<leader>rev', "<esc><CMD>lua require('jdtls').extract_variable(true)<CR>",
        { buffer = bufnr, desc = "Extract variable" })
    map('n', '<leader>rec', "<CMD>lua require('jdtls').extract_constant()<CR>",
        { buffer = bufnr, desc = "Extract constant" })
    map('x', '<leader>rec', "<ESC><CMD>lua require('jdtls').extract_constant(true)<CR>",
        { buffer = bufnr, desc = "Extract constant" })
    map('x', '<leader>rem', "<ESC><CMD>lua require('jdtls').extract_method(true)<CR>",
    ...
    local lsp_settings = {
        java = {
            ...
            format = {
                enabled = true,
                settings = {
                    url = '/home/thxgg/.config/nvim/styleguides/eclipse-java-google-style.xml'
                },
            }
        },
        signatureHelp = {
