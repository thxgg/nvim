return {
  {
    ...
    keys = {
      ...
      { "<leader>fds", "<CMD>Telescope lsp_document_symbols<CR>",          desc = "[F]ind [D]ocument [S]ymbols" },
      { "<leader>fws", "<CMD>Telescope lsp_dynamic_workspace_symbols<CR>", desc = "[F]ind [W]orkspace [S]ymbols" },
      -- Util
